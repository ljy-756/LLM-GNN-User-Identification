...
from utils.data_loader_fusion_3 import load_graph_data_for_fusion
from model.fusion_gcn_bert_3 import FusionModel
...
def main():
    with open("utils/configs/fusion_3.yaml", "r", encoding="utf-8") as f:
    ...
    torch.save(model.state_dict(), os.path.join(save_dir, "fusion_gcn_bert_3.pt"))
