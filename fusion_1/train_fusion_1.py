...
from utils.data_loader_fusion_1 import load_graph_data_for_fusion
from model.fusion_gcn_bert_1 import FusionGCN1
...
def main():
    with open("utils/configs/fusion_1.yaml", "r", encoding="utf-8") as f:
    ...
    print("Learned alpha:", torch.sigmoid(model.alpha).item())
    # 评估
    ...
    torch.save(model.state_dict(), os.path.join(save_dir, "fusion_gcn_bert_1.pt"))
