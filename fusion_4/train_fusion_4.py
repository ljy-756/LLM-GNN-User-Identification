...
from utils.data_loader_fusion_4 import load_graph_data_for_fusion
from model.fusion_gcn_bert_4 import FusionModel
...
def main():
    with open("utils/configs/fusion_4.yaml", "r", encoding="utf-8") as f:
    ...
    torch.save(model.state_dict(), os.path.join(save_dir, "fusion_gcn_bert_4.pt"))
