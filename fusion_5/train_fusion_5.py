...
from utils.data_loader_fusion_5 import load_graph_data_for_fusion
from model.fusion_gcn_bert_5 import FusionModel
...
def main():
    with open("utils/configs/fusion_5.yaml", "r", encoding="utf-8") as f:
    ...
    torch.save(model.state_dict(), os.path.join(save_dir, "fusion_gcn_bert_5.pt"))
